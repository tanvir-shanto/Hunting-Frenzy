...
public class Bunny extends Animal {
   ...
   public Bunny(int type) {
      ...
      if (type == 1) {
         ...
         this.dx = -2;
         this.spriteSheet = Asset.bunnySprite_1;
      } else if (type == 2) {
         this.x = -280 + this.rand.nextInt(200);
         this.y = 542 + this.rand.nextInt(80);
         this.dx = 2;
         this.spriteSheet = Asset.bunnySprite_2;
      }
   ...
   public void tick() {
      ...
      } else if (this.type == 2 && this.x > 1024) {
         this.x = -280 + this.rand.nextInt(200);
         this.y = 542 + this.rand.nextInt(80);
      }
